...
using QuanLyDonHang.Models1.QuanLyMucDoDichVu;
using System;
using System.Data;
using System.Linq;
...
namespace QuanLyMucDoDichVu.ControllersAPI
{
    [Route("api/mucdichvu")]
    [ApiController]
    public class QuanLyMucDoDichVu : ControllerBase
    {
        ...
        public QuanLyMucDoDichVu(TmdtContext context, ILogger<QuanLyMucDoDichVu> logger, IMemoryCache cache, ISystemService sys)
        {
            _context = context;
            _logger = logger;
            _cache = cache;
        ...
        [Authorize]
        [HttpPost("themmoi")]
        public async Task<IActionResult> ThemMoi([FromBody] MucDoDichVuCReate model)
        {
            if (model == null)
            {
        ...
        [Authorize]
        [HttpPut("chinhsua")]
        public async Task<IActionResult> ChinhSua([FromBody] MucDoDichVuUpdata model)
        {
